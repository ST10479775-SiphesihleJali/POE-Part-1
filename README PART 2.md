...
## Changelog – Part 1
### Added
- **7 HTML pages** for website structure:  
  - `index.html`  
  - `about.html`  
  - `programs.html`  
  - `impact.html`  
...
- Page content: hero section, about section, impact stats, programs, stories, events, resources, contact form  
- Embedded YouTube video in Resources page  
- Accessibility (alt attributes, form validation, comments)  
...
- Fixed-dimension images (not responsive)  
- README lacked detail and changelog  

---

## Changelog – Part 2 Development Log
**25/09/2025**
- Created external stylesheet (`style.css`)  
- Added typography system  
- Developed responsive navigation (mobile menu)  

**26/09/2025**
- Card-grid layout for Programs & Impact pages  
- Styled contact form  
